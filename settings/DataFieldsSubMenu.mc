...
class SettingsDataFieldsMenu extends WatchUi.Menu2 {
  public function initialize() {
    ...
    if (System.SCREEN_SHAPE_ROUND == System.getDeviceSettings().screenShape) {
      ...
      SettingsMainMenu.toggleItem(
        self,
        "Font Size",
        "Bigger",
        "Standard",
        AppStorage.KEY_14_CFG_FONT_SIZE,
        Config.getFontSize()
      );
    }
  }
...
class DataPointSettings extends WatchUi.Drawable {
  ...
  public function useSmall() {
    mSettingsLabels = [
      "Steps",
      Toybox has :Weather and (Toybox.Weather has :getCurrentConditions) ? "Humidity" : "Not Available",
      Toybox has :Weather and (Toybox.Weather has :getCurrentConditions) ? "Precipitation" : "Not Available",
      Activity.getActivityInfo() has :rawAmbientPressure ? "Atm. Pressure" : "Not available",
      "Calories Total",
      "Calories Active",
      ActivityMonitor.getInfo() has :floorsClimbed ? "Floors Climbed" : "Not Available",
      Activity.getActivityInfo() has :currentOxygenSaturation ? "Pulse Ox" : "Not available",
      "Heart Rate",
      "Notifications",
      System.getSystemStats() has :solarIntensity and System.getSystemStats().solarIntensity != null
        ? "Solar Intensity"
        : "Not available",
      "Seconds",
      "Digital Clock",
      "Intensity Min.",
      Toybox has :SensorHistory && Toybox.SensorHistory has :getBodyBatteryHistory ? "Body Battery" : "Not Available",
      Toybox has :SensorHistory && Toybox.SensorHistory has :getStressHistory ? "Stress" : "Not Available",
      ActivityMonitor.getInfo() has :respirationRate ? "Respiration Rate" : "Not Available",
      ActivityMonitor.getInfo() has :timeToRecovery ? "Recovery Time" : "Not Available",
      UserProfile.getProfile() has :vo2maxRunning ? "VO2 Max Run" : "Not Available",
      UserProfile.getProfile() has :vo2maxCycling ? "VO2 Max Cycle" : "Not Available",
      Toybox has :Weather && (Weather has :getSunset and (Weather has :getSunrise))
        ? "Next Sun Event"
        : "Not Available",
      "Battery %/day",
      Toybox has :Weather and (Toybox.Weather has :getHourlyForecast) ? "2h Forecast" : "Not Available",
      "None",
    ];
  ...
  public function useBig() {
    mSettingsLabels = [
      ...
      "Distance",
      "Elevation",
      Toybox has :Weather and (Toybox.Weather has :getCurrentConditions) ? "Wind Speed" : "Not Available",
      Toybox has :Weather and (Toybox.Weather has :getCurrentConditions) ? "Min/Max Temp." : "Not Available",
      Toybox has :Weather and (Toybox.Weather has :getCurrentConditions) ? "Humidity" : "Not Available",
      Toybox has :Weather and (Toybox.Weather has :getCurrentConditions) ? "Precipitation" : "Not Available",
      Activity.getActivityInfo() has :rawAmbientPressure ? "Atm. Pressure" : "Not available",
      "Calories Total",
      ...
      Toybox has :Weather && (Weather has :getSunset and (Weather has :getSunrise))
        ...
        : "Not Available",
      "Battery %/day",
      Toybox has :Weather and (Toybox.Weather has :getHourlyForecast) ? "3h Forecast" : "Not Available",
      "None",
    ];
  ...
  function draw(dc) {
    ...
    } //TODO figuring out, why white color is set to gray. And if there better ways to solve the purpose of it
